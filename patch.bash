...
#    INSERT OR IGNORE INTO AUTHOR_EXPERIENCE
#        (ANALYSIS_KEY)
#        SELECT COMMIT_TIME_DIFFS.CREATION_ANALYSIS_KEY
#          FROM AUTHOR_EXPERIENCE
#    INNER JOIN COMMIT_TIME_DIFFS
#            ON AUTHOR_EXPERIENCE.ISSUE_KEY = COMMIT_TIME_DIFFS.ISSUE_KEY
#         WHERE AUTHOR_EXPERIENCE.IS_FIX = 0;
#'
#run_query '
#    INSERT OR IGNORE INTO AUTHOR_EXPERIENCE
#        (ANALYSIS_KEY)
#        SELECT COMMIT_TIME_DIFFS.CLOSE_ANALYSIS_KEY
#          FROM AUTHOR_EXPERIENCE
#    INNER JOIN COMMIT_TIME_DIFFS
#            ON AUTHOR_EXPERIENCE.ISSUE_KEY = COMMIT_TIME_DIFFS.ISSUE_KEY
#         WHERE AUTHOR_EXPERIENCE.IS_FIX = 1;
#'
